...
> Status note (2026-06-23): This is a historical review, not a live status
> page. Several items called out here have changed since publication. In
> particular, runtime errors now include source line/column information when
> evaluated through `parseAndEvaluate(...)` or script imports; regex literals,
> base conversion, block import headers, and tensor shape validation have
> evaluator test coverage. Generator/lazy-generator support and `{$ ... }`
> constraint semantics remain incomplete.
